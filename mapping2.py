...
command_mapping = {
    ...
    "set_ventilation_level_0": [0x84,0x15,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x00,0x00,0x00,0x00],
    "set_ventilation_level_1": [0x84,0x15,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x01,0x00,0x00,0x00],
    "set_ventilation_level_2": [0x84,0x15,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x02,0x00,0x00,0x00],
    "set_ventilation_level_3": [0x84,0x15,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x03,0x00,0x00,0x00],
    # operating mode: sendmsg.py lines 56-57 (type=0x08)
    "auto_mode":   [0x85,0x15,0x08,0x01],
    "manual_mode": [0x84,0x15,0x08,0x01,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x01],
    # bypass: sendmsg.py lines 35+38 (type=0x02); open/close value matches bypass_mode_enum
    "auto_bypass":  [0x85,0x15,0x02,0x01],
    "open_bypass":  [0x84,0x15,0x02,0x01,0x00,0x00,0x00,0x00,0x10,0x0E,0x00,0x00,0x01,0x00,0x00,0x00],
    "close_bypass": [0x84,0x15,0x02,0x01,0x00,0x00,0x00,0x00,0x10,0x0E,0x00,0x00,0x02,0x00,0x00,0x00],
    # temperature profile (TEMPHUMCONTROL=0x1D, extrapolated from ventilation level pattern)
    "temperature_profile_normal": [0x84,0x1D,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x00,0x00,0x00,0x00],
    "temperature_profile_cool":   [0x84,0x1D,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x01,0x00,0x00,0x00],
    "temperature_profile_warm":   [0x84,0x1D,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x02,0x00,0x00,0x00],
    # menu mode (NODECONFIGURATION=0x20, extrapolated from ventilation level pattern)
    "basis_menu":    [0x84,0x20,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x00,0x00,0x00,0x00],
    "extended_menu": [0x84,0x20,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x00,0x01,0x00,0x00,0x00],
}
